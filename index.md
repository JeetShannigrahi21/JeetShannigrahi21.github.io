...
<p>
     ...
     Prof. Mona Berciu
      ...
      on understanding the temperature dependence of the effective mass and lifetime
      of the Holstein and SSH polaron in cubic lattices. Prior to my graduate
      studies at UBC, I graduated from the Bachelor of Science (Honours) Physics
      program at
  ...
  <aside class="bio-sidebar">
    <img src="{{ '/assets/images/profile.jpg?v=3' | relative_url }}"
         alt="Jeet Shannigrahi"
         class="about-photo">
