...
<section id="talks" class="section">
  ...
  <ul class="items">
    <li class="cv-item">
      <div class="cv-item-head">
        <span class="cv-item-venue"><strong>Theory Canada 17 &amp; CAP Congress 2025</strong>, University of Saskatchewan, Canada</span>
    ...
    <li class="cv-item">
      <div class="cv-item-head">
        <span class="cv-item-venue"><strong>APS Global Physics Summit 2025</strong>, Anaheim, USA &ndash; Online/Virtual Component</span>
    ...
    <li class="cv-item">
      <div class="cv-item-head">
        <span class="cv-item-venue"><strong>APS March Meeting 2024</strong>, USA &ndash; Online/Virtual Component</span>
    ...
    <li class="cv-item">
      <div class="cv-item-head">
        <span class="cv-item-venue"><strong>GCURS 2023</strong>, Rice University, USA</span>
  ...
  <ul class="items">
    <li class="cv-item">
      <div class="cv-item-head">
        <span class="cv-item-venue"><strong>First International Quantum Horizons Symposium</strong>, Banff, Canada</span>
        <span class="cv-item-date"><em>August 2025</em></span>
      </div>
      <div class="cv-item-sub">
        Poster title: Temperature-dependent Properties of the 3D Holstein polaron.
      </div>
    </li>
